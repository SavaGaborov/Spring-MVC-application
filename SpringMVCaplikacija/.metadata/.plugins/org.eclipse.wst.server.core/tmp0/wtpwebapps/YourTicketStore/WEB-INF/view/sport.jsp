...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="resources/css/contactstil.css" title="style" />
</head>
...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>${message}</h1>
        <p>Here is a list of sports events that we suggest You to visit:</p>
		
        <form action="#" method="post">
          <div class="form_settings">
            <p><textarea class="contact textarea" rows="25" cols="50" name="your_enquiry"></textarea></p>
          </div>
        </form>
        <p><br /><br />Do not hesitate to contact us about some specific offers, maybe it is not published yet.</p>
      </div>
    </div>
    <div id="footer">
